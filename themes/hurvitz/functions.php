...
function hurvitz_scripts() {
    ...
    wp_enqueue_style( 'hurvitz-main',    get_template_directory_uri() .'/assets/css/main.css', '', '1.0.2' );


	wp_enqueue_script( 'swiper', get_template_directory_uri() . '/assets/js/swiper.min.js', array( 'jquery' ), '', true );
	wp_enqueue_script( 'hurvitz', get_template_directory_uri() . '/assets/js/script.js', array( 'jquery' ), '1.0.2', true );
